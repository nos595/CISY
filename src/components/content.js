    ...
    const renderHandler = (props) => {
        switch(props.page){
            ...
            case "faq":
                ...
                You absolutely can! I have very little formal training and no formal experience, but if you can see past that, I am very much in the market! I've been sat behind a keyboard since I was six and have experience in JS, PHP, SQL, HTML & CSS. This is my first proper forray into React and I'm enjoying it a lot!<br />Get in touch at jonmatthewbarton(at)gmail(dot)com if you want to know more.<br /><br />...Okay, that last one isn't frequently asked, but a guy can dream! =P
            </p>;
